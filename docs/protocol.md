...
`reload` у BridgeTab завжди виконується як hard reload з `bypassCache: true`, щоб сторінка підтягувала актуальні CSS, JS і мініфіковані bundles без використання браузерного кешу.
